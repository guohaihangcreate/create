...
<script type="text/javascript">
	function toEditeInfo(Id){
		document.forms[0].action="<%=path%>/customerInfoController/toEditeCustomerZcProjectList.go?id="+Id;
		document.forms[0].submit();
	}
	
	function todeletInfo(Id){
		document.forms[0].action="<%=path%>/customerInfoController/deleteCustomerZcProjectList.go?id="+Id;
		document.forms[0].submit();
	}
					...
					<td height="100%" valign="top">
						<div style="overflow: auto; height: 100%; width: 100%">
							<table width="100%" border="0" cellpadding="3" cellspacing="1"
								...
								<c:forEach items="${zcprojectList}" var="zcproject">
									<TR class="BGCgray">
										<TD align="center" nowrap="nowrap">
											<input type="checkbox" name="checkbox2" id="checkbox2">
										</TD>
										<TD align="center" nowrap="nowrap">
											${zcproject.projectname}
										</TD>
										<TD align="center" nowrap="nowrap">
											${zcproject.projectadress}
										</TD>
										<TD align="center" nowrap="nowrap">
											${zcproject.yl1}
										</TD>
										<TD width="200" align="center" nowrap="nowrap">
											<BUTTON style="height: 21px; font-size: 12px"
												onClick="toEditeInfo('${zcproject.id}');">
												修改
											</BUTTON>
											<BUTTON style="height: 21px; font-size: 12px"
												onClick="todeletInfo('${zcproject.id}');">
												删除
											</BUTTON>
										</TD>
									</TR>
 ...
 $('#divtest').contextMenu('myMenu1', 
 {
	  bindings: 
	  {
		...
		'add_project': function(t) {
			document.forms[0].action="<%=path%>/view/crm/zcproject_add_or_edite.jsp?cid=${cid}";
		    document.forms[0].submit();
		}
	  }
