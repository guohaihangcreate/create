...
<tr>
	<td colspan="5">
		...
		<c:choose>
			...
			<c:otherwise>
				<a href="${pathurl}&pageAction=first${urlParams}"><label style="color: blue;">&lt&lt首页&nbsp;</label></a>&nbsp;
				<a href="${pathurl}&pageAction=previous${urlParams}" /><label style="color: blue;">&lt上一页</label></a>
			</c:otherwise>
		</c:choose>
		&nbsp;||&nbsp;
		<c:choose>
			...
			<c:otherwise>
				<a href="${pathurl}&pageAction=next${urlParams}" ><label style="color: blue;">下一页 &gt&nbsp;</label> </a>&nbsp;
				<a href="${pathurl}&pageAction=last${urlParams}" /><label style="color: blue;">末页&gt&gt</label></a>
			</c:otherwise>
		</c:choose>
		&nbsp;
