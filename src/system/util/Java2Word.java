...
public class Java2Word {
	...
	public static void main(String[] args) {
		...
		String docfile = "/usr/tomcat/apache-tomcat-6.0.45/webapps/create/WebRoot/template/offer/offer_template_default.doc";
		...
		testMap.put("rzlxrmobil", "15801579188");
		testMap.put("syq", "2");
		// 税前工资
	...
	public void toWord(String inputPath, String outPath, HashMap data) {
		...
		try {
			...
			System.out.println("toword[Java2Word]------------操作word文件失败！"+e.getMessage());
		} finally {
			if (doc != null)
				close(doc);
		}
