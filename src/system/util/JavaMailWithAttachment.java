...
public class JavaMailWithAttachment {
	...
	public JavaMailWithAttachment(boolean debug) {
		InputStream in = JavaMailWithAttachment.class
				.getResourceAsStream("/config/MailServer.properties");
		try {
			properties.load(in);
	...
	public void doSendHtmlEmail(String subject, String sendHtml,
		...
		try {
			...
			contentPart.setContent(sendHtml, "text/html;charset=gb2312");
	...
	public static void main(String[] args) {
		...
		File affix = new File(
				"C:\\Program Files (x86)\\Apache Software Foundation\\Tomcat 6.0\\webapps\\create\\sendedOffer\\安静&&14519649818185164.doc");
		se.doSendHtmlEmail("测试java发送邮件主题", "测试java发送邮件容",
				"guohaihang@xiangmu.ren", affix);//
